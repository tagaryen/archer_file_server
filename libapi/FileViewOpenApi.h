...
namespace api 
{
class FileViewOpenApi : public fs::server::HttpHandler
{
public:
    FileViewOpenApi(std::shared_ptr<fs::service::FileService> const& fileService) {
...
private:
    std::string   m_uri = FS_OPEN_API_FILE_VIEW;
